...
{
    public class When_game_board_evolves_a_live_cell_with_four_neighbours : GameBoardSpecification
    {
        ...
        [It]
        public void Should_have_that_cell_dead()
        {
            _nextGeneration.StatusOfCell(_expectedX, _expectedY).Should().Be.False();
        }
    }
}