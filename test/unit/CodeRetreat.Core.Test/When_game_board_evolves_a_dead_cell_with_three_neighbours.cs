...
{
    public class When_game_board_evolves_a_dead_cell_with_three_neighbours : GameBoardSpecification
    {
        ...
        protected override void GivenThat()
        {
            ...
            _startCells = Enumerable.Create(new Pair<int, int>(_expectedX - 1, _expectedY + 1), 
                new Pair<int, int>(_expectedX, _expectedY + 1), 
                new Pair<int, int>(_expectedX + 1, _expectedY + 1));
        }
